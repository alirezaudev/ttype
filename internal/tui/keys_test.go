...
func TestEveryBindingHasKeysAndHelp(t *testing.T) {
	...
	bindings := []key.Binding{
		...
		testKeys.Restart, testKeys.DeleteWord, testKeys.Backspace, testKeys.Skip,
...
func TestHelpLinesComeFromTheBindings(t *testing.T) {
	...
	if got, want := testHelpLine(), "tab/enter restart - esc/ctrl+c quit - ctrl+bksp/ctrl+w delete word"; got != want {
